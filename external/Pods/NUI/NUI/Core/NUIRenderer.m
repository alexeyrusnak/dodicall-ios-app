...
+ (void)renderButtonAndSetNuiClass:(UIButton*)button withClass:(NSString*)className
{
    button.nuiClass = [className copy];
...
+ (void)renderLabelAndSetNuiClass:(UILabel*)label withClass:(NSString*)className
{
    label.nuiClass = [className copy];
