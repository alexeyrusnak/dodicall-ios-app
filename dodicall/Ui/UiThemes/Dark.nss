...
NavigationBar {
    ...
    background-color-highlighted: @colorBlack;
...
TabBar {
    ...
    selection-indicator-image:@imageBgBlack;
}
TabBarItem {
    font-name: @fontName;
    font-color: #FFFFFF;
...
UiContactProfileUnblockContactButton
{
    ...
    font-color: @colorWhite;
    background-color:@colorGrey;
    background-color-highlighted: @colorGreyLight;
    background-color-disabled: @colorGreyLight;
    corners-radius:18,18,18,18;
}
...
UiChatsListCellViewIndicatorViewOFFLINE
{
    background-color:@colorGrey;
    corner-radius:3;
}
UiChatsListCellViewIndicatorViewONLINE
{
    background-color:@colorGreen;
    corner-radius:3;
}
UiChatsListCellViewIndicatorViewDND
{
    background-color:@colorYellow;
    corner-radius:3;
}
UiChatsListCellViewIndicatorViewAWAY
{
    background-color:@colorYellow;
    corner-radius:3;
}
UiChatsListCellViewIndicatorViewINVISIBLE
{
    background-color:@colorGrey;
    corner-radius:3;
}
...
{
    background-image:bubble_regular;
