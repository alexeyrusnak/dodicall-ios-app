...
@interface UiLoginPageViewModel : NSObject

@property NSString* LoginText;
@property NSString* PasswordText;
@property NSString* AppVersionText;
@property NSNumber* IsFormValid;
@property NSNumber* IsLoginProcessActive;
@property NSNumber* UiLanguageTextValue;
@property NSNumber* LastResultSuccess;
@property NSString* LastResultErrorText;

- (void) ExecuteLoginProcess;
//- (void) FinishLoginProcess;
- (void) ExecuteUiLanguageTapProcess;
//- (void) ExecuteLogoTapProcess;
