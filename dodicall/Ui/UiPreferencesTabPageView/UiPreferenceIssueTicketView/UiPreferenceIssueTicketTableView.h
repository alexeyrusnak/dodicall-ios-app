//
//  UiPreferenceIssueTicketTableView.h
//  dodicall
//
...
@interface UiPreferenceIssueTicketTableView : UITableViewController

@property (nonatomic) UiPreferenceIssueTicketTableViewModel* ViewModel;
